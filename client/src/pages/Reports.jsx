  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-4">
        ...
        {(statusFilter !== 'All' || roleFilter !== 'All' || credentialTypeFilter !== 'All') && (
          <div className="mt-4">
            <button
              onClick={() => {
                setStatusFilter('All');
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-semibold">
            {reportType === 'credentials' ? 'Credential Status Report' : 'Missing Required Credentials'}
            <span className="ml-2 text-sm text-gray-600">
              ({reportType === 'credentials' ? filteredCredentials.length : getMissingCredentials().length} records)
            </span>
          </h3>
        </div>
